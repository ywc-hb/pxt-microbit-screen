...
displayImageParameters(70, 10, 2, pika_stay.listOfColor, pika_stay.paletteOfColors, pika_stay.width, pika_stay.height, pika_stay.numberOfOccurence, -1, false, displayPikachuStay());
...
displayImage(displayPikachuRun(), 1, 1, 1)
