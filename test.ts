...
displayImage(10, 10, 2, pika_run.listOfColor, pika_run.paletteOfColors, pika_run.width, pika_run.height, 1, pika_run.numberOfOccurence, -1);

LCD1IN8.LCD_DisplayWindows(8, 8, (pika_run.width - 1) * 2 + 10, (pika_run.height - 1) * 2 + 10);

let pika_stay = displayPikachuStay();
displayImage(70, 10, 2, pika_stay.listOfColor, pika_stay.paletteOfColors, pika_stay.width, pika_stay.height, 1, pika_stay.numberOfOccurence, -1);
