...
displayImage(10, 10, 2, pika_run.listOfColor, pika_run.paletteOfColors, pika_run.width, pika_run.height,
...
displayImage(70, 10, 2, pika_stay.listOfColor, pika_stay.paletteOfColors, pika_stay.width, pika_stay.height,
